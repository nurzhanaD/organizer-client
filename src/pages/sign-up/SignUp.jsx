            ...
            <form className='sign-up__form'>
                ...
                <div className="sign-up-form__wrapper">
                    <div className="sign-up-form__item">
                        ...
                        <Input type='text' value={firstName} change={e => setFirstName(e.target.value)} classStyle='input-sign'></Input>
                    </div>
                    <div className="sign-up-form__item">
                        <label className='sign-up-form__label'>Фамилия:</label>
                        <Input type='text' value={lastName} change={e => setLastName(e.target.value)} classStyle='input-sign'></Input>
                    </div>
                </div>
                <div className="sign-up-form__wrapper">    
                    <div className="sign-up-form__item">
